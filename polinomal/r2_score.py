...
print("Polynomial Degree 2 R2")
print(r2_score(Y,lin_reg2.predict(poly_reg.fit_transform(X))))
print("#"*20)

print("Polynomial Degree 4 R2")
print(r2_score(Y,lin_reg3.predict(poly_reg2.fit_transform(X))))
print("#"*20)

print("Polynomial Degree 6 R2")
print(r2_score(Y,lin_reg4.predict(poly_reg3.fit_transform(X))))
print("#"*20)
